...
namespace toio.Tests.Core
{
    ...
    public class TestBuildScript
    {
        ...
        static string CreateScript(string targetDir)
        {
            ...
            // 1.テスト関数を取得
            var testMethods = GetTestMethods(typeof(ToioTestCase), typeof(ToioTest));
            ...
            foreach(var m in testMethods)
            {
                ...
                sb = sb.AppendLine($"test.tests.Add( new {nameof(BasicToioTest)}( {varName}.{methodName} ) );");
            }
        ...
        static string CreateTestScene(string testScriptPath, string targetDir)
        {
            ...
            const string OriginalTestScenePath = "Assets/toio-sdk/Tests/ToioMode/Core/Scene/TestScene.unity";
