...
Unity のバージョンは **Unity 2022.3.2f1LTS** を利用してください。（Unity 2022.3.2f1LTS にて動作確認を行っております。もっと新しい Unity を使いたい場合は、各々の責任でお試しください。Unity 2020LTSを使いたい場合はtoio SDK for Unity v1.4を利用してください。Unity 2021LTSを使いたい場合はtoio SDK for Unity v1.5を利用してください。）
