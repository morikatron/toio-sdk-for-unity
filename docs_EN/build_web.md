...
For other browsers, please refer to [WebGL](https://developer.mozilla.org/ja/docs/Web/API/WebGL_API) and [web-bluetooth](https://webbluetoothcg.github.io/web-bluetooth/).
- WebGL
  - [WebGL compatibility across browsers](https://docs.unity3d.com/ja/2019.4/Manual/webgl-browsercompatibility.html)
...
2. In WebGL Settings window, open Resolution and Presentation, and click [webble] in WebGL Template item.
...
Then, Sample_UI will be added to the list of "Scenes included in the build". Click "Build and Run" to continue.
...
1. Login to [github](https://github.com) and [create](https://docs.github.com/ja/github/getting-started-with-github/create-a-repo) a repository. <br>
The repository name should be `[username].github.io`.

2. [Clone](https://docs.github.com/ja/github/creating-cloning-and-archiving-repositories/cloning-a-repository) the remote repository you created.

3. Copy the web app directory generated by Unity engine (`e.g. Sample_UI/`) into the cloned repository directory.

4. Add the directory of the added web app to the remote repository [add](https://docs.github.com/ja/github/managing-files-in-a-repository/adding-a-file-to-a-repository-using-the-command-line).
