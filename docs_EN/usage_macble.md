...
If your OS version is <b>10.x</b> or <b>11.x</b>, please refer to [How to download a pre-built bundle file](usage_macble.md#How-to-download-a-pre-built-bundle-file).
...
If you want to check the operation easily, try running the sample project [Sample_ConnectType](./toio-sdk-unity/Assets/toio-sdk/Samples/Sample_ConnectType/).
